...
public class StringUtil
{
	 ...
	 *            The string to split
	 * @param splitter
	 *            The string that forms the boundary between the two strings
	 *            returned.
	...
	/**
	 * Create a full reference from a relative reference merged with a root
	 * reference.
	 * 
	 * @param root
	 ...
	 * @param value
	 *            The string to trim.
	 * @return value trimmed of blanks, lower cased, and if nothing left, made
	 *         null.
	 */
	...
	/**
	 * Trim blanks, and assure there is a value, and it's not null, then
	 * lowercase.
	 * 
	 * @param value
	 *            The string to trim.
	 ...
	 * @return true of the target contains the substring anywhere, ignore case,
	...
	/**
	 * Compare two strings for differences, either may be null, ignore case if
	 * specified
	 * 
	 * @param a
	 *            One String.
	...
	public static boolean different(String[] a, String[] b)
	{
		...
		// now we know neither are null, so compare, item for item (order
		// counts)
	...
	/**
	 * Limit the string to a certain number of characters, adding "..." if it
	 * was truncated
	 * 
	 * @param value
	 *            The string to limit.
	 ...
	 * @return true if the string was found
	 */
	public static boolean containsIgnoreCase(Collection stringCollection,
			String value)
	{
		if ((stringCollection == null) || (value == null))
		{
	 ...
	 * @return true if the string was found
	 */
	public static boolean containsIgnoreCase(String[] stringCollection,
			String value)
	{
		if ((stringCollection == null) || (value == null))
		{
	...
	/**
	 * Determine if a String is contained in a String [], ignoring case or not
	 * as specified
	 * 
	 * @param stringCollection
	 *            The String[] to scan
