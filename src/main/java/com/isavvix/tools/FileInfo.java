...
public class FileInfo
{
    ...
    public static String getFileName(String fileName) {
        if (fileName != null) {
            ...
            int index  = Math.max(indexa,indexb);
            
            String name = (index >= 0) ? fileName.substring(index + 1) : new String(fileName);
    ...
    public String getFileName() { return getFileName(clientFileName); }
